...
class StoreShell extends StatelessWidget {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (i) {
          switch (i) {
            case 0: GoRouter.of(context).go(RouteNames.storeDashboardPath);
            case 1: GoRouter.of(context).go(RouteNames.storeProductsPath);
            case 2: GoRouter.of(context).go(RouteNames.storeOrdersPath);
            case 3: GoRouter.of(context).go(RouteNames.storeFinancePath);
            case 4: GoRouter.of(context).go(RouteNames.storeSettingsPath);
          }
        },
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.account_balance_outlined), selectedIcon: Icon(Icons.account_balance), label: 'Tài chính'),
  ...
  int _tabIndex(BuildContext context) {
    ...
    if (loc == RouteNames.storeProductsPath) return 1;
    if (loc == RouteNames.storeOrdersPath) return 2;
